...
import ua.dnepr.valera.crypto.bot.model.Bot3Fibo;
...
//        System.out.println("      History:  \n" + longPosition.printEntryPriceAmountHistory());
        ...
        Bot3Fibo bot3Fibo = new Bot3Fibo(1L, "BTC", new BigDecimal("10000"));
        bot3Fibo.createFiboOpenOrders(new BigDecimal("10000"), new BigDecimal("10"), new BigDecimal("0.3"), new BigDecimal("1"), new BigDecimal("5"), new BigDecimal("10000"), MyPosition.Side.SHORT);
